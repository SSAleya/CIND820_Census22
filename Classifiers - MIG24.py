...
import numpy as np
import pandas as pd
df =pd.read_csv (r'C:\Users\sania\Data analytics\Course materials 820\Latest census\Initial Data analysis\Information gain\Census22_24MI.csv')
...
data ={'Accuracy' : [0.80, 0.85, 0.69, 0.80, 0.82],
        'MCC' : [0.60, 0.69, 0.44, 0.61, 0.63]}
my_color =['g','blue']
...
Time= [2.79, 18.56, 1.79, 9.88, 5.60]
...
Classifiers = ['DT','RF','NB','LR','KNN']       
Time= [102.37, 147.76, 52.96, 1304.28, 519.73]
