...
df1 = df.loc[:,["PENATVTY","PEMNTVTY", "PEFNTVTY", "PEMLR", "A_MARITL", "A_HGA", "A_AGE", "A_MJIND", "A_MJOCC", "A_HRSPAY", "CAP_VAL", "DIV_VAL", "FILESTAT", "STATETAX_A", "STATETAX_B", "HHDFMX", "HHDREL","WKSWORK","NOEMP","Income"]]
...
data ={'Accuracy' : [0.78, 0.84, 0.63, 0.79, 0.82],
        'MCC' : [0.57, 0.68, 0.34, 0.59, 0.63]}
my_color =['g','blue']
...
data ={'Accuracy' : [0.79, 0.83, 0.63, 0.78, 0.81],
        'MCC' : [0.57, 0.65, 0.34, 0.57, 0.63]}
my_color =['g','blue']
df = pd.DataFrame(data,columns=['Accuracy','MCC'], index = ['DT','RF','NB','LR','KNN'])
...
Classifiers = ['DT','RF','NB','LR','KNN']       
Time= [96.60, 152.42, 45.79, 1227.64, 502.94]
