...
import numpy as np
import pandas as pd
df =pd.read_csv (r'C:\Users\sania\Data analytics\Course materials 820\Latest census\Initial Data analysis\Correlation Cofficients\Not_high_corr.csv')
...
data ={'Accuracy' : [0.47, 0.52, 0.34, 0.44, 0.50],
        'MCC' : [0.34, 0.41, 0.19, 0.30, 0.37]}
my_color =['g','blue']
...
Time= [0.66, 10.39, 0.16, 9.86, 30.25]
...
data ={'Accuracy' : [0.48, 0.51, 0.35, 0.36, 0.50],
        'MCC' : [0.35, 0.39, 0.20, 0.21, 0.38]}
my_color =['g','blue']
df = pd.DataFrame(data,columns=['Accuracy','MCC'], index = ['DT','RF','NB','LR','KNN'])
...
Classifiers = ['DT','RF','NB','LR','KNN']       
Time= [65.92, 124.26, 10.28, 1821.31, 2169.55]
